...
import com.gantara.mohfajar.DetailAtlet.RekamMedis.RekamMedisFragment.OnListFragmentInteractionListener;
...
public class MyRekamMedisRecyclerViewAdapter extends RecyclerView.Adapter<MyRekamMedisRecyclerViewAdapter.ViewHolder> {
    ...
    private List<RekamMedis> mValues;

    private OnListFragmentInteractionListener mListener;

    public MyRekamMedisRecyclerViewAdapter(List<RekamMedis> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void updateData(List<RekamMedis> rekamMedis){
        this.mValues.clear();
