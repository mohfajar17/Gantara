...
import com.gantara.mohfajar.Base64;
...
public class SignupActivity extends AppCompatActivity implements SignupContract.View{
    ...
    private SignupContract.Presenter mSignuPresenter;
    ...
    public void insertDaftar() {
        ...
        if (nama.matches("") || jenisKelamin.matches("2") || tempatLahir.matches("") || tanggalLahir.matches("") || alamat.matches("") || noTelefon.matches("") || userName.matches("") || password.matches("") || photoProfile.matches("")) {
            ...
            mSignuPresenter.signup(userName, password, nama, jenisKelamin, tempatLahir, tanggalLahir, alamat, noTelefon, photoProfile);
        }
    }

    @Override
    public void setPresenter(SignupContract.Presenter presenter) {
        this.mSignuPresenter = presenter;
    }
