...
public class SignupRemoteDataSource implements SignupDataSource{
    ...
    @Override
    public void setSignup(@NonNull final InsertSignupCallBack callback, final String idPsikolog, final String userName, final String password, final String nama, final String jenisKelamin, final String tempatLahir, final String tanggalLahir, final String alamat, final String asalKota, final String noTelfon, final String cabor, final String photo) {
